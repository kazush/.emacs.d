...
(defvar my/default-background (if window-system "#282c34" "#000000"))
(defun my/setup-faces ()
  "Set faces for my preference."
  (interactive)
  (set-face-attribute 'default nil
                      :foreground "#abb2bf"
                      :background my/default-background)
...
;; Toggle transparency
(defvar my/transparency 0.8)
(defun my/toggle-transparency ()
  "Toggle transparency of background of default face."
  (interactive)
  (if window-system
      (let ((alpha (frame-parameter nil 'alpha)))
        (if (eql alpha my/transparency)
            (progn
              (set-frame-parameter nil 'alpha 1.0)
              (set-face-background 'default my/default-background))
          (set-frame-parameter nil 'alpha my/transparency)
          (set-face-background 'default "black")))
    (set-face-background
     'default
     (if (string= (face-attribute 'default :background) "unspecified")
         my/default-background "unspecified"))))
#+end_src
...
(use-package treesit
  ...
  (setq treesit-language-source-alist
        '((bash "https://github.com/tree-sitter/tree-sitter-bash")
          ...
          (js . ("https://github.com/tree-sitter/tree-sitter-javascript" "v0.20.1"))
...
(use-package ellama
  ...
  (setopt ellama-providers
          '(("gemini-2.0-flash" . (my/make-llm-gemini
            ...
            ("gemini-2.0-flash-lite" . (my/make-llm-gemini
                                        :chat-model "gemini-2.0-flash-lite"))
            ("gemini-2.0-flash-preview" . (my/make-llm-gemini
                                        :chat-model "gemini-2.0-flash-preview-image-generation"))
            ("gemini-2.5-flash-preview" . (my/make-llm-gemini
                               :chat-model "gemini-2.5-flash-preview-04-17"))
            ("gemini-2.5-pro-preview" . (my/make-llm-gemini
