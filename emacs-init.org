...
(use-package org-roam
  ...
  (defun my/org-roam-project-create-new-file (prj basename)
  ...
  (defun my/org-roam-project-capture (prj basename entry-str)
    ...
    (let* ((file (format "%s/projects/%s/%s.org"
      ...
      (unless (file-exists-p file)
        (my/org-roam-project-create-new-file prj basename))
      (org-capture nil "d")))
