...
(defun my/setup-faces ()
  ...
  (custom-set-faces
   ...
   '(ediff-current-diff-A ((t :foreground nil :background "#403030")))
   '(ediff-current-diff-B ((t :foreground nil :background "#304030")))
   '(ediff-current-diff-C ((t :foreground nil :background "#404030")))
   '(ediff-fine-diff-A ((t :foreground nil :background "#504040")))
   '(ediff-fine-diff-B ((t :foreground nil :background "#405040")))
   '(ediff-fine-diff-C ((t :foreground nil :background "#505040")))
   '(ediff-even-diff-A ((t :foreground nil :background "#403030")))
   '(ediff-even-diff-B ((t :foreground nil :background "#304030")))
   '(ediff-even-diff-C ((t :foreground nil :background "#404030")))
   '(ediff-odd-diff-A ((t :foreground nil :background "#403030")))
   '(ediff-odd-diff-B ((t :foreground nil :background "#304030")))
   '(ediff-odd-diff-C ((t :foreground nil :background "#404030")))
   '(diff-refine-removed ((t :foreground nil :background "#504040")))
   '(diff-refine-added ((t :foreground nil :background "#405040")))
   '(diff-refine-changed ((t :foreground nil :background "#404030"))))
...
(use-package org
  ...
  :hook ((org-mode . org-indent-mode)
         ...
         (org-after-todo-state-change . my/org-update-clock))
  :custom
      ...
      ((agenda ""
       ...
       (todo ""
             ((org-super-agenda-groups
               '((:name "Deadline Today" :deadline today)
                 (:name "Scheduled Today" :scheduled today)
                 (:name "Overdue" :deadline past)
                 (:name "Scheduled Past" :scheduled past)
                 (:name "Next" :todo "NEXT")
                 (:name "Active" :todo "ACTIVE")
                 (:name "Blocked/Waiting" :todo ("BLOCKED" "WAITING"))
                 (:discard (:anything t))))
              (org-agenda-overriding-header "Tasks")))
       (tags-todo "+PROJECT=\"personal\"-TODO=\"SHOPPING\""
                  ((org-super-agenda-groups
                    '((:todo "NEXT")
                      (:todo "TODO")
                      (:todo "ACTIVE")
  ...
  (defun my/org-update-clock ()
    ...
    (interactive)
    (require 'org-clock)
    (if (string= org-state org-clock-in-switch-to-state)
        (org-clock-in)
      (when (org-clocking-p)
        (org-clock-out))))
