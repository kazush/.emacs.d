...
#+begin_src emacs-lisp
(use-package vertico
  :if (eq my/completion-ui 'vertico)
...
#+begin_src emacs-lisp
(use-package fussy
  :if (>= (string-to-number emacs-version) 27.2)
  :config
...
(use-package helm-c-yasnippet :if (eq my/completion-ui 'helm))
#+end_src
...
(use-package helm-org-rifle :if (eq my/completion-ui 'helm))
  ...
  (when (eq my/completion-ui 'vertico)
    (defvar my/consult-source-inactive-exwm-buffer
      `(:name "EXWM"
              ...
              :category buffer
              :state ,#'consult--buffer-state
              :items ,#'my/get-inactive-exwm-buffers))
    ...
    (defun my/consult-inactive-exwm-buffers ()
      ...
      (if (my/get-inactive-exwm-buffers)
          (consult-buffer my/consult-exwm-buffer-source)
