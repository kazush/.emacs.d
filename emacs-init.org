...
(use-package tab-bar
  :bind (("C-z w" . tab-bar-move-window-to-tab)
         ("C-z !" . tab-close-other)
         ("C-z 1" . my/tab-bar-switch-to-1)
         ("C-z 2" . my/tab-bar-switch-to-2)
         ("C-z 3" . my/tab-bar-switch-to-3)
         ("C-z 4" . my/tab-bar-switch-to-4)
         ("C-z 5" . my/tab-bar-switch-to-5)
         ("C-z 6" . my/tab-bar-switch-to-6)
         ("C-z 7" . my/tab-bar-switch-to-7)
         ("C-z 8" . my/tab-bar-switch-to-8)
         ("C-z 9" . my/tab-bar-switch-to-9))
  :config
  ...
  (org-agenda-custom-commands
   '(("d" "Today"
      ((todo "NEXT"
       ...
       (agenda ""
               ((org-agenda-overriding-header (format-time-string "🗓 %a, %b %e %Y"))
