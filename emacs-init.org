...
(defvar my/max-windows-per-frame 3)
...
#+begin_src emacs-lisp
(use-package ghostel
  :straight (:type git :host github :repo "dakra/ghostel" :files ("*.el" "etc"))
  :bind (("C-c g" . my/ghostel))
  ;; Comment out as key-translate is now used instead of define-key key-translation-map.
  ;; :hook ((ghostel-mode . my/ghostel-setup-keymap))
  :custom
