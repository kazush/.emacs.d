...
(use-package tab-bar
  :bind (("C-x C-f" . my/find-file-other-tab)
         ...
         ("C-x K" . kill-buffer)
         ("C-x b" . my/switch-to-buffer-maybe-other-tab)
         :map tab-prefix-map
  ...
  (defun my/switch-to-buffer-other-tab (buf)
...
files will be visited."
  ...
  (defun my/switch-to-buffer-maybe-other-tab ()
    "Switch to another tab if a given buffer is already displayed there,
otherwise in this tab."
    (interactive)
    (let* ((bufname (consult--read (mapcar #'buffer-name (consult--buffer-query))
                                   :category 'buffer
                                   :require-match
                                   (confirm-nonexistent-file-or-buffer)
                                   :prompt "Switch to: "
