...
#+begin_src emacs-lisp
(use-package tab-bar
  :bind (("C-x C-f" . my/find-file-other-tab)
         ("C-x k" . my/tab-bar-kill-buffer-and-window-or-tab)
         ("C-x K" . kill-buffer)
         ("C-x b" . my/switch-to-buffer-other-tab)
         :map tab-prefix-map
  ...
  (defun my/find-file-other-tab (filename &optional wildcards)
    ...
    (let ((value (find-file-noselect filename nil nil wildcards)))
      (if (listp value)
          (progn
            ...
            (my/switch-to-buffer-other-tab (car value))
            (mapc #'switch-to-buffer (cdr value))
            value)
        (my/switch-to-buffer-other-tab value))))
