...
;; Use this function if you want to change font and/or size of the default font.
(defun my/set-fontset-font (&optional font size fset)
  "Set font for default face."
  (interactive "sFont: \nsSize: \ni")
  (let ((newfont (my/make-font-str (if (string-empty-p font) my/default-font font)
                                   (if (string-empty-p size) my/default-font-size
...
(use-package gptel
  ...
  (defun my/gptel-new ()
    ...
    (let ((buf (find-file-noselect
                (format-time-string
                 (concat my/gptel-save-directory      "/gptel-%Y%m%d%H%M%S.org")) t)))
      (pop-to-buffer buf)
...
(use-package eaf-browser
  ...
  (eaf-bind-key kill-buffer-and-window ";" eaf-browser-keybinding)
  (eaf-bind-key insert_or_scroll_down_page "<backspace>" eaf-browser-keybinding)
  (eaf-bind-key nil "M-q" eaf-browser-keybinding) ;; unbind, see more in the Wiki
  (eaf-bind-key insert_or_scroll_down_page "<backspace>" eaf-browser-keybinding)
  (eaf-bind-key kill-buffer "q" eaf-browser-keybinding)
