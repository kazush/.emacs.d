  ...
  (let ((b (my/find-last-shellish-buffer (buffer-list (selected-frame))
    ...
    (cond ((or (not b) (= arg 64))
          ...
          ((my/shellish-buffer-p (current-buffer) shell-str)
           (when my/last-non-shellish-buffer
...
(defun my/get-term (arg)
  (interactive "p")
  (my/get-shellish arg 'multi-term "term"))
...
(use-package exwm
  ...
  ;; Override C-z (suspend-frame)
  (exwm-input-set-key (kbd "C-z") #'keyboard-escape-quit)
  ...
  (exwm-input-set-key (kbd "s-<tab>") #'my/switch-to-last-buffer)
